...
class MlAdaBoostClassification(ClassificationBase):
    def __init__(self, target_variable):
        ...
        self.plt_folder = 'ada_boost'
        super(MlAdaBoostClassification, self).__init__(target_variable)

def ada_boost(data_file, target_variable):
    # create object with target variable name
    ml = MlAdaBoostClassification(target_variable)
...
if __name__ == '__main__':
    ada_boost(TELCO_CHURN_DATA, 'Churn') # with scaler and removal of high correlated features
